...
public final class Funct {
	...
	/**
	 * For two given point particles of specified constant velocities and initial
	 * positions, returns an array of length two containing:
	 * <ul>
	...
	public static double[] timeClosest(double x1, double y1, Vector2D vel1, double x2, double y2, Vector2D vel2) {
		...
		if (vel1.equals(vel2))
			...
			output[0] = Math.max(0,
					-(xDiff * xVelDiff + yDiff * yVelDiff) / (xVelDiff * xVelDiff + yVelDiff * yVelDiff));
		}
